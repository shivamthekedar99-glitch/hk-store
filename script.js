...
const products = [
  ...
  {
    id: 17,
    name: "Premium Stainless Steel Vegetable Chopper",
    category: "kitchen-essentials",
    price: 699, mrp: 1299,
    rating: 4.2, reviews: 0,
    image: "https://i.ibb.co/DHLXDSBq/shopping.webp",
    gallery: [
      "https://i.ibb.co/DHLXDSBq/shopping.webp", "https://i.ibb.co/21rmRqLf/watermarked-img-3228701004356182996.jpg"],
    description: "A durable and convenient stainless-steel vegetable chopper designed to make everyday kitchen preparation faster and easier. It is suitable for chopping vegetables, fruits, herbs and other common kitchen ingredients.",
    features: ["Suitable for vegetables, fruits, herbs and other kitchen ingredients", "Easy to use", "Easy to clean", "Compact and suitable for everyday kitchen use"],
    specs: [
      "Product type: Manual Vegetable Chopper",
      "Material: Stainless Steel + Food-grade plastic",
      "Capacity: Approximately 900 ml",
      "Blade material: Stainless Steel",
      "Operation: Manual pull mechanism"
    ],
    includes: [
      "1 × Stainless Steel Vegetable Chopper",
      "Stainless Steel blade",
      "Pull handle mechanism",
      "Container"
    ],
    isNew: true, isBestSeller: false, dateAdded: "2026-08-25"
  }
];
